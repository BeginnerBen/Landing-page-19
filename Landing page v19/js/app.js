...
var html = [
	...
	'<li><button class="buttonStyle" onclick="scrollFunction(1)"> Seciton 1  </button> </li>',
	'<li><button class="buttonStyle" onclick="scrollFunction(2)"> Seciton 2 </button>  </li>',
	'<li><button class="buttonStyle" onclick="scrollFunction(3)"> Seciton 3 </button></li>',
	'<li><button class="buttonStyle" onclick="scrollFunction(4)"> Seciton 4 </button></li>',
	'</ul>',
